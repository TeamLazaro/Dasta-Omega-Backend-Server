...
*/
	...
	"roboto-slab-light" => array(
        'R' => "RobotoSlab-Light.ttf"
        ),
	
	"roboto-slab-thin" => array(
        'R' => "RobotoSlab-Thin.ttf"
        ),
	
	"roboto-slab-bold" => array(
        'R' => "RobotoSlab-Bold.ttf"
        ),
	...
	"dosis-semi-bold" => array(
        'R' => "Dosis-SemiBold.ttf"
        ),
	
	"museo-sans-rounded" => array(
