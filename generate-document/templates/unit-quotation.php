	...
	<body>
		<htmlpagefooter name="firstpage">
			<table width="100%">
				<tr>
					<td width="33%"> </td>
					<td width="33%" align="center" style="color: white; font-size: 1pt"> </td>
		...
		<htmlpagefooter name="otherpages">
			<table width="100%">
				<tr>
					<td width="33%">Page {PAGENO} of {nb}</td>
					<td width="33%" align="center" style="color: white; font-size: 1pt"><?php echo ( empty( $author ) ? '' : 'Generated by ' . $author ) . ' ' . $_engineVersion ?></td>
					<td width="33%" style="text-align: right">Generated on {DATE jS, F Y}</td>
				</tr>
			</table>
		</htmlpagefooter>
		<div class="wrap">
			...
			<sethtmlpagefooter name="firstpage" value="on" show-this-page="1"></sethtmlpagefooter>
			<pagebreak />
			<sethtmlpagefooter name="firstpage" value="off"></sethtmlpagefooter>
			<sethtmlpagefooter name="otherpages" value="on"></sethtmlpagefooter>
