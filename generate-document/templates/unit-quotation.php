...
<html class="no-js" lang="en">
	...
	<body>
		<htmlpagefooter name="allpages">
			<table width="100%">
				<tr>
					<td width="33%">Page {PAGENO} of {nb}</td>
					<td width="34%" align="center" style="color: white; font-size: 1pt"><?php echo ( empty( $author ) ? '' : 'Generated by ' . $author ) . ' ' . $_engineVersion ?></td>
					<td width="33%" style="text-align: right">Generated on {DATE jS, F Y}</td>
				</tr>
			</table>
		</htmlpagefooter>
		<sethtmlpagefooter name="allpages" value="on" />
		<div class="wrap">
