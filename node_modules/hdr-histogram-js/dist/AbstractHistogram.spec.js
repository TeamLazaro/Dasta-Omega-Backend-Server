...
describe("Histogram encoding", function () {
    ...
    it("should decode reading a byte buffer", function () {
        ...
        buffer.position = 0;
        // when
        var result = AbstractHistogram_1.default.decodeFromByteBuffer(buffer, Int32Histogram_1.default, 0);
        // then
    ...
    it("should decode and decompress reading a byte buffer", function () {
        ...
        var buffer = new ByteBuffer_1.default(base64.toByteArray("HISTFAAAACB42pNpmSzMwMDAxAABMJqRQf4/GNh/gAgEMwEAkp4I6Q=="));
        // when
        var histogram = AbstractHistogram_1.default.decodeFromCompressedByteBuffer(buffer, Int32Histogram_1.default, 0);
        // then
    ...
    it("should encode and compress an histogram", function () {
        ...
        var decodedHistogram = AbstractHistogram_1.default.decodeFromCompressedByteBuffer(buffer, Int32Histogram_1.default, 0);
        chai_1.expect(decodedHistogram.outputPercentileDistribution()).to.be.equal(histogram.outputPercentileDistribution());
    });
});
