...
describe("Histogram encoding", function () {
    it("should decode and decompress reading a base64 string", function () {
        ...
        // when
        var histogram = hdr.decodeFromCompressedBase64(base64String);
        // then
    ...
    it("should encode and compress an histogram to a base64 string", function () {
        // given
        var histogram = new hdr.Int32Histogram(1, 2, 3);
        histogram.recordValue(42);
        // when
        var base64Histogram = hdr.encodeIntoBase64String(histogram);
        // then
    ...
    it("should throw an error when trying to decompress an histogram using V1 encoding", function () {
        ...
        chai_1.expect(function () {
            return hdr.decodeFromCompressedBase64(base64V1EncodingString);
