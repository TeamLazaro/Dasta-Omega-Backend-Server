...
export default abstract class AbstractHistogram extends AbstractHistogramBase {
    ...
    fillBufferFromCountsArray(buffer: ByteBuffer): void;
    /**
     * Encode this histogram into a ByteBuffer
     * @param buffer The buffer to encode into
     * @return The number of bytes written to the buffer
     */
    encodeIntoByteBuffer(buffer: ByteBuffer): number;
    private fillCountsArrayFromSourceBuffer(sourceBuffer, lengthInBytes, wordSizeInBytes);
    private establishInternalTackingValues(lengthToCover?);
    private static getCookieBase(cookie);
    private static getWordSizeInBytesFromCookie(cookie);
    static decodeFromByteBuffer(buffer: ByteBuffer, histogramConstr: HistogramConstructor, minBarForHighestTrackableValue: number): AbstractHistogram;
    static decodeFromCompressedByteBuffer(buffer: ByteBuffer, histogramConstr: HistogramConstructor, minBarForHighestTrackableValue: number): AbstractHistogram;
    /**
     * Encode this histogram in compressed form into a byte array
     * @param targetBuffer The buffer to encode into
     * @return The number of bytes written to the array
     */
    encodeIntoCompressedByteBuffer(targetBuffer: ByteBuffer, compressionLevel?: number): number;
    reset(): void;
}
